...
(function(){
  ...
  boot.innerHTML=`
    ...
    <div class="final-copy"><p class="kicker">WELCOME TO</p><h1><span>AWAIS</span><span>IRSHAD</span></h1><div class="portfolio">PORTFOLIO</div><p class="manifesto">I TURN DATA INTO <strong>INTELLIGENCE.</strong></p><a class="cta" href="#home" id="finalEnter">EXPLORE MY WORK&nbsp; ↗</a></div>`;
